...
const correctExpenseModal = `
            <!-- ADD EXPENSE MODAL -->
            <div v-if="activeModal === 'expenseModal'" class="space-y-4 text-xs">
              <div class="space-y-4">
...
html = html.replace(/<!-- ADD EXPENSE MODAL -->[\s\S]*?(?=<!-- PHOTO LIGHTBOX MODAL -->)/, correctExpenseModal);
